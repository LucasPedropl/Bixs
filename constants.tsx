...
export const SPECIALTIES: Specialty[] = [
	{
		...
		description:
			'Sempre buscando as melhores tecnologias para seu negócio.',
	...
	},
	{
		...
		description:
			'Conte com uma equipe pronta para atender suas necessidades.',
...
export const PRODUCTS: Product[] = [
	{
		...
		title: 'Papi Fast',
		description:
			'Automação e controle para estabelecimentos com grande fluxo.',
	...
	},
	{
		...
		icon: (
			<div className="flex flex-col items-center">
				...
				<span className="text-2xl font-bold text-primary-700 mt-2">
					Agente+
				</span>
			</div>
		),
