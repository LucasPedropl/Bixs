...
const Products: React.FC = () => {
  return (
    <section id="products" className="py-16 md:py-24 bg-slate-50 border-t border-slate-200">
          ...
          {PRODUCTS.map((product) => (
            <div key={product.id} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-primary-900/10 transition-all duration-500 border border-slate-100">
              ...
              <div className="p-6 md:p-8 flex-grow flex flex-col">
                <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-3 group-hover:text-primary-600 transition-colors">
                  {product.title}
                </h3>
                <p className="text-slate-500 text-sm leading-relaxed mb-6 md:mb-8 flex-grow">
                  {product.description}
                </p>
                ...
                <div className="mt-auto">
                    ...
                    className="w-full py-3 md:py-4 rounded-xl flex items-center justify-center gap-2 bg-slate-50 text-slate-900 font-bold text-sm border border-slate-200 group-hover:bg-primary-600 group-hover:text-white group-hover:border-primary-600 transition-all duration-300"
                    >
                    Saiba Mais
